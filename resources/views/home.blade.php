@extends('layouts.app')
@section('title', __('CLI+ | Un equipo de marketing dentro de tu empresa'))
@section('description', __('Una agencia de comunicación, publicidad y marketing digital. Dinos en qué podemos ayudarte, nos adaptamos a ti y a tu negocio. ¿Y si somos lo que necesitas?'))
    ...
    <article class="equipo">
        <div class="container">
            <div class="txt">
                ...
                <a class="button" href="{{ localized_route('agencia') }}" title="Conoce la agencia y el equipo">@lang('conócenos')
    ...
    <article class="services bg-blue text-white">
        <div class="container">
            ...
            <div class="txt">
                <div class="item">
                    <img class="icon"
                        src="{{ asset('img/diseño-desarrollo-web.png') }}"
                        alt="@lang('Nos dedicamos al diseño y desarrollo web, son técnicas SEO y responsive.')" 
                        title="@lang('Diseño y desarrollo web')"
                    >
                ...
                <div class="item">
                    <img class="icon"
                        src="{{ asset('img/redes-sociales.png') }}"
                        alt="@lang('Community management, gestión y creación de perfiles sociales.')" 
                        title="@lang('Gestión de Redes Sociales')"
                    >
                ...
                <div class="item">
                    <img class="icon"
                        src="{{ asset('img/branding.png') }}"
                        alt="@lang('Diseño gráfico, identidad y valor de marca.')" 
                        title="@lang('Branding')"
                    >
            ...
            <a class="button-white button" href="{{ localized_route('services') }}" title="Oferta de servicios de CLI+ comunicación">@lang('más servicios' )
            <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="long-arrow-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M311.03 131.515l-7.071 7.07c-4.686 4.686-4.686 12.284 0 16.971L387.887 239H12c-6.627 0-12 5.373-12 12v10c0 6.627 5.373 12 12 12h375.887l-83.928 83.444c-4.686 4.686-4.686 12.284 0 16.971l7.071 7.07c4.686 4.686 12.284 4.686 16.97 0l116.485-116c4.686-4.686 4.686-12.284 0-16.971L328 131.515c-4.686-4.687-12.284-4.687-16.97 0z"></path></svg>
        </a>
        </div>
    ...
    <article class="contact bg-pink">
        <div class="container">
            ...
            <div class="txt">
                ...
                <a class="button" href="{{ localized_route('contact') }}" title="Ir al formulario de contacto">@lang('Cuéntanos')
                    <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="long-arrow-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M311.03 131.515l-7.071 7.07c-4.686 4.686-4.686 12.284 0 16.971L387.887 239H12c-6.627 0-12 5.373-12 12v10c0 6.627 5.373 12 12 12h375.887l-83.928 83.444c-4.686 4.686-4.686 12.284 0 16.971l7.071 7.07c4.686 4.686 12.284 4.686 16.97 0l116.485-116c4.686-4.686 4.686-12.284 0-16.971L328 131.515c-4.686-4.687-12.284-4.687-16.97 0z"></path></svg>
                </a>
            </div>
            <div class="img">
